...
public class CoachController {
  ...
  /*  @Autowired
    public CoachController(Coach theCoach){ //@Qualifier has higher priority than @Primary qualifier
        myCoach = theCoach;
    }*/
   ...
   public void setCoach(@Qualifier("tennisCoach") Coach theCoach){ //works in setter type injection also
    ...
    @Autowired
    public CoachController(@Qualifier("cricketCoach") Coach theCoach){ //added qualifier annotation
        myCoach = theCoach;
    }
